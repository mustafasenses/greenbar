...
function composeStack(art, p, stats) {
...
export function buildBlock(art, p, layout, stats) {
  if (layout === 'side') return composeSide(art, p, stats);
  if (layout === 'stack') return composeStack(art, p, stats);
  return art;
}
